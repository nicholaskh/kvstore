...
class INIReader
{
  public:
    ...
    long long GetLongLong(std::string section, std::string name, long long default_value) const;
...
inline long long INIReader::GetLongLong(std::string section, std::string name, long long default_value) const
{
    std::string valstr = Get(section, name, "");
    const char *value = valstr.c_str();
    char *end;
