...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MasterOperator_master_5fsm_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MasterOperator_master_5fsm_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_master_5fsm_2eproto = {
  false, false, descriptor_table_protodef_master_5fsm_2eproto, "master_sm.proto", 147,
...
static bool dynamic_init_dummy_master_5fsm_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_master_5fsm_2eproto)), true);
namespace phxpaxos {
...
MasterOperator::MasterOperator(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:phxpaxos.MasterOperator)
}
...
void MasterOperator::ArenaDtor(void* object) {
  MasterOperator* _this = reinterpret_cast< MasterOperator* >(object);
  (void)_this;
}
void MasterOperator::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ...
          lastversion_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* MasterOperator::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(4, this->_internal_operator_(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(6, this->_internal_lastversion(), target);
  }
...
void MasterOperator::InternalSwap(MasterOperator* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MasterOperator, sid_)
      + sizeof(MasterOperator::sid_)
      - PROTOBUF_FIELD_OFFSET(MasterOperator, nodeid_)>(
...
template<> PROTOBUF_NOINLINE ::phxpaxos::MasterOperator* Arena::CreateMaybeMessage< ::phxpaxos::MasterOperator >(Arena* arena) {
  return Arena::CreateMessageInternal< ::phxpaxos::MasterOperator >(arena);
}
